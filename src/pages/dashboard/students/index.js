...
const rows = [
  ...
  createData(9012345678, 'Sofía', 'Ortiz García', 'Avenida Circunvalar # 12-34, ConjuntoResidencial Los Rosales, Cali', 39),
  createData(3123456709, 'Luis', 'González Castro', 'Carrera 8 # 23-45, Barrio La Floresta,Barranquilla', 23),
  createData(2345678901, 'Catalina', 'Rueda Gómez', 'Calle 60 # 12-34, ConjuntoResidencial El Bosque, Cartagena', 42),
  createData(3456789012, 'Diego', 'Mendoza Hernández', 'Carrera 50 # 30-45, BarrioAlameda, Bucaramanga', 28)
];
const Students = () => {
  return (
    <Stack spacing={3}>
